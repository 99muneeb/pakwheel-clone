# Generated by Django 3.0.7 on 2021-08-03 06:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('PU', 'Punjab'), ('KPK', 'Khyber Pukhtunkhwa'), ('BL', 'Balochistan'), ('SN', 'Sindh'), ('FD', 'Federal Territory')], max_length=100)),
                ...
                ('features', models.CharField(choices=[('Cruise Control', 'Cruise Control'), ('Audio Interface', 'Audio Interface'), ('Airbags', 'Airbags'), ('Air Conditioning', 'Air Conditioning'), ('Seat Heating', 'Seat Heating'), ('Alarm System', 'Alarm System'), ('PakAssist', 'PakAssist'), ('Power Steering', 'Power Steering'), ('Reersing Camera', 'Reersing Camera'), ('Direct Fuel Injection', 'Direct Fuel Injection'), ('Auto Start/Stop', 'Auto Start/Stop'), ('Wind Deflector', 'Wind Deflector'), ('Bluetooth Handset', 'Bluetooth Handset')], max_length=100)),
